...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const filesPath = utils_1.findFileSync(/src((\/|\\)[a-z0-9\s_@\-^!#$%&+={}\[\]]+)*(\/|\\)supportedExtensions\.js/, rootDir)[0];
            const foldersPath = utils_1.findFileSync(/src((\/|\\)[a-z0-9\s_@\-^!#$%&+={}\[\]]+)*(\/|\\)supportedFolders\.js/, rootDir)[0];
